...
class Podcastmodel extends CI_Model {
    ...
    var $column_order = array(null,'pm.event_title','pm.event_desc','pm.event_location','pm.event_datatime',null); 
    ...
    private function _get_datatables_query() {
        ...
        if($new_str) {
            ...
            foreach ($explode_string as $show_string) {  
                $cond  = " ";
                $cond.=" ( pm.event_datatime LIKE '%".trim(date('Y-m-d',strtotime($show_string)))."%' ";
