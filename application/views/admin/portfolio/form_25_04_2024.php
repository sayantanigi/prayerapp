				...
				<div class="card">
					<div class="card-body">
						<?php if ($button == 'Update') { ?>
							<form action="<?php echo admin_url('Manage_podcast/update_action'); ?>" method="post"
								enctype="multipart/form-data">
							<?php } else { ?>
								<!-- <form class="forms-sample" action="<?php echo admin_url('Manage_podcast/create_action'); ?>"
								...
								<div class="form-group">
									...
									<input class="form-control" type="text" placeholder="Example: Podcast Name"
										name="podcast_name" value="<?= @$podcast_name; ?>" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input class="form-control" type="text" placeholder="Example: Singer Name"
										name="podcast_singer_name" value="<?= @$podcast_singer_name; ?>" required>
								</div>
								...
								<div class="mt-4">
									...
									<button class="btn btn-primary submit_button" type="button" onclick="return update_our_event();">Submit</button>
