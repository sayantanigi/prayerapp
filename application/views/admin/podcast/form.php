			...
			<div class="col-xl-12">
				...
				<div class="card">
					<div class="card-body">
	        			...
	        			<form  action="<?php echo admin_url('Manage_podcast/update_action'); ?>" method="post" enctype="multipart/form-data">
	            		<?php } else { ?>
	            		...
	            		<?php } ?>
							...
							<div class="form-group">
								<img src="<?php echo base_url()?>/uploads/podcast/cover_image/<?= @$podcast_cover_image?>" style="width: 150px;">
							</div>
							<?php } else { ?>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<audio controls><source src="<?php echo base_url()?>/uploads/podcast/podcast_file/<?= @$podcast_file?>"></audio>
							</div>
							<?php } else { ?>
							<div class="form-group">
