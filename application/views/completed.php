                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-12">
                                    <div class="contact__btn">
                                        <button type="button" class="e-btn" onclick="send_message()">Send your
                                            message</button>
                                    </div>
                                </div>
                        ...
                        <div class="contact__social">
                            ...
                            <ul>
                                ...
                                <li><a href="<?= @$settings->tw_link; ?>" class="tw"><i class="fa fa-twitter"
                                            aria-hidden="true"></i></a></li>
                                <li><a href="<?= @$settings->insta_link; ?>" class="pin"><i class="fa fa-instagram"
                                            aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="f_content  mt-5 d-flex">
                        ...
                        <ul class="app_sec">
                            ...
                            <li>/</li>
                            <li><a href="https://play.google.com/store/apps/details?id=com.onetwentyarmyprayer">Google
                                    Play</a></li>
                        </ul>
