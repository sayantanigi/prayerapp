...
<head>
    ...
    <title>120 ARMY - Event Details</title>
    ...
    <section class="container Data_Container">
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div><p><?= $prayerEvents->prayer_subheading ?></p></div>
            ...
            <div class="col-12">
                <!-- <img style="width: 100%; height: 500px; object-fit: cover;"
                    ...
                    <?php if (!empty($prayerEvents->prayer_image)) { ?>
                        <img style="width: 100%; height: 500px; object-fit: cover; border-radius: 20px;"  src="<?= base_url() ?>uploads/prayer/<?= $prayerEvents->prayer_image ?>" >
                                            <?php } else { ?>
                                                <img style="width: 100%; height: 500px; object-fit: cover;" src="<?= base_url() ?>uploads/no_image.png" alt="" style="height: 250px">
                                            <?php } ?>
            </div>
