...
class Manage_videos extends CI_Controller {
    ...
    public function update($id) {
        ...
        $data=array(
            'heading'=>'Edit Video',
            'button'=>'Update',
            'videos_cat_id'=>set_value('videos_cat_id',$update_vid->videos_cat_id),
            ...
            'videos_type'=>set_value('videos_type',$update_vid->videos_type),
            'videos_file'=>set_value('videos_file',$update_vid->videos_file),
            'videos_link'=>set_value('videos_link',$update_vid->videos_link),
            'id'=>$vid_id,
