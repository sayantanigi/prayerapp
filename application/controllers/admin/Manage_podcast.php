    ...
    public function ajax_manage_page() {
        ...
        foreach ($GetData as $row) {
            ...
            if(!empty($row->cover_image)) {
                if(!file_exists("uploads/podcast/cover_image/".$row->cover_image)) {
                    $img ='<img class="rounded service-img mr-1" src="'.base_url('uploads/no_image.png').'">';
                } else {
                    $img ='<a href="'.base_url('uploads/podcast/cover_image/'.$row->cover_image).'" data-lightbox="roadtrip"><img class="rounded service-img mr-1"src="'.base_url('uploads/podcast/cover_image/'.$row->cover_image).'"><a>';
                }
            } else {
                $img ='<img class="rounded service-img mr-1" src="'.base_url('uploads/no_image.png').'">';
            }
