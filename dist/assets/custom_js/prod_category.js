function create_category() {
	...
	$.ajax({
		type:"post",
		url:admin_url+"Product_category/create_action",
		cache:false,
		contentType: false,
		processData:false,
		async:false,
...
function getValue(id) {
	...
	$.ajax({
		type:'post',
		cache:false,
		url:admin_url+'Product_category/get_value',
		data:{
			id:id,
		},
		success:function(returndata) {
...
function update_category() {
	...
	$.ajax({
		type:"post",
		url:admin_url+"Product_category/update_action",
		cache:false,
		contentType: false,
		processData:false,
		async:false,
	...
	$.confirm({
	    ...
	    buttons: {
	        confirm: function () {
				...
				$.ajax({
					type:"POST",
					url:admin_url+'Product_category/delete',
					data:datastring,
					cache:false,
					success:function(returndata) {
						if(returndata = 1){
